...
select coalesce(email,'unknow') as email from employees
...
--17
 ...
 select distinct productname from products where price>50
 select distinct price from products where price>50
 --23
